# options(renv.config.library = "/mnt/share/R/R_Libraries")
# Sys.setenv(RENV_PATHS_CACHE = "/mnt/share/R/R_renv_cache")
# Sys.setenv(TMPDIR = "/mnt/share/R/R_Temp")
#credentials::set_github_pat()
# library(gitcreds)
# gitcreds_set()

#usethis::use_git_config(user.name = "Alexandru-Emil", user.email = "alexandru-emil.matei@med.uni-duesseldorf.de")
#usethis::create_github_token()
#credentials::set_github_pat()
#remotes::install_github("Alexandru-Emil/spomad")
...
if (length(missing_bioconductor) > 0) {
  BiocManager::install(missing_bioconductor, ask = TRUE, update = TRUE)
  packages_installed <- TRUE  # Update the flag
}
